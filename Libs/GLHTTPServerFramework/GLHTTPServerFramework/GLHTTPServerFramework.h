...
// URI composition information //
 
 As delegates of this server class has to mention the uri for which they want to handle the incoming local requests, it is important that delegates class user understands the format of uri to be used.
 
 Consider below uri for instance
 www.google.com/xyz/pqr?arg1=abc,agr2=nmc
 
 In above case the uri identifier should only be /xyz/pqr. delegates should not expect that string following ? will also be a part of uri.
 */
...
#import <GLHTTPServerFramework/GLHTTPServer.h>
#import <GLHTTPServerFramework/GLHTTPRequest.h>
#import <GLHTTPServerFramework/GLHTTPRequestDelegate.h>
#import <GLHTTPServerFramework/GLHTTPResponse.h>
